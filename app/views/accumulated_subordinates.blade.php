...
<head>
    <title>Accumulated Hours - Subordinates Report | Time and Electronic Attendance Monitoring System</title>
</head>

<h1>Accumulated Hours - Subordinates</h1>

<div class='col-md-4'>
{{ Form::open(array('url' => 'employee/reports/accumulated_sub', 'method' => 'get')) }}
