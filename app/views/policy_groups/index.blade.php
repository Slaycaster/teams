      ...
      <div class="col-md-5">
        ...
        <div class="cold-md-12">
          <div class="col-md-6" style="margin-bottom:5px">
               ...
               <a href="{{ URL::to('policy_groups/' . $policy_group->id) }}" onclick="window.open('{{ URL::to('policy_groups/' . $policy_group->id) }}', 'newwindow', 'width=450, height=500'); return false;">View</a>
                    |
               <a href="{{ URL::to('policy_groups/' . $policy_group->id . '/edit') }}" onclick="window.open('{{ URL::to('policy_groups/' . $policy_group->id . '/edit') }}', 'newwindow', 'width=450, height=450'); return false;">Edit</a>
          </div>
