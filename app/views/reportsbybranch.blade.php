...
$pdf->Output('reports/branch.pdf');

?>
<iframe src="../reports/branch.pdf" title="downloads"  height= "450" width="100%"  frameborder="0" margin-left= "100px" target="Message"></iframe>
