...
<head>
    <title>Your Accumulated Hours Report | Time and Electronic Attendance Monitoring System</title>
</head>

<h1>Your Accumulated Hours</h1>


{{ Form::open(array('url' => 'employee/reports/accumulated', 'method' => 'get')) }}
<div class = "row">
    <div class='col-md-4'>
