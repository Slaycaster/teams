...
<head>
    <title>Punctuality Assessment Report | Time and Electronic Attendance Monitoring System</title>
</head>

<h1>Punctuality Assessments</h1>

<div class='col-md-4'>
{{ Form::open(array('url' => 'report/assessment', 'method' => 'get')) }}
...
<br><iframe src="../reports/<?=$dynamic_name?>_assessment.pdf" title="downloads"  height= "450" width="100%"  frameborder="0" margin-left= "100px" target="Message"></iframe>
